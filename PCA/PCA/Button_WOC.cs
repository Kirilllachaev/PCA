...
namespace ePOSOne.btnProduct
{
    public class Button_WOC : Button
    {
        ...
        private Color _onClickedButtonColor = Color.Yellow;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
			...
			if (_isClicked) 
            {
                brush = new SolidBrush(_onClickedButtonColor);
            }
			else
			{
        ...
        public Color OnClickedButtonColor
        {
            get => _onClickedButtonColor;
            set
            {
                _onClickedButtonColor = value;
                Invalidate();
            }
        }
